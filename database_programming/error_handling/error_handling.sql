...
CALL insertar_alumno(1, 'Juan', 'Pérez', 'García', @error1);
SELECT @error1 AS Resultado1;

CALL insertar_alumno(1, 'Ana', 'López', 'Martínez', @error2);
SELECT @error2 AS Resultado2;

CALL insertar_alumno(2, 'Francisco', 'García', 'Moreno', @error3);
SELECT @error3 AS Resultado3;